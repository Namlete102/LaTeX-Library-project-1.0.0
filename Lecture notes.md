...
Triết gia và nhà toán học người Hy Lạp cổ đại xứ Samos Pythagoras
...
Viết lại **ví dụ 1** trên bằng môi trường `cases`: 
...
Kết quả cho ra được vẫn sẽ tương tự với kết quả ta có được ở  **ví dụ 1**. 
...
Để viết chỉ số trên người dùng sử dụng lệnh `^`, còn chỉ số dưới người dùng sử dụng lệnh `_` . 
...
Ví dụ . . . với phương trình trường hấp dẫn Einstein mô tả trọng lực không phải là một lực kéo thông thường theo quan điểm cổ điển của nhà vật lý Isaac Newton, mà là hệ quả của sự uốn cong không-thời gian do khối lượng và năng lượng . . .  gây ra.  
...
Ví dụ với công thức Euler về mối liên hệ giữa đỉnh, cạnh, mặt của khối đa diện lồi. Với mọi khối đa diện lồi nào, số đỉnh trừ đi số cạnh cộng với số mặt luôn là bằng 2: 
