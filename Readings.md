...
![19 màu cơ bản](LaTeX-Library-project-1.0.0/images/img1.1.jpg)
...
```
![68  màu CMYK](LaTeX-Library-project-1.0.0/images/img1.2.jpg)

2. `x11names`: tải 317 màu được đặt tên (RGB) 
```latex
\usepackage[x11names]{xcolor}
```
![317 màu RGB ](LaTeX-Library-project-1.0.0/images/img1.3.jpg)
